<template>
    <div id="demo" class="cropperImg">
        ...
        <div>
            <div class="show" style="height:1.6rem;width:1.6rem;">
                <div class="picture" :style="'backgroundImage:url('+headerImage+')'" style="height:1.6rem;width:1.6rem;"></div>
            </div>
            <div style="opacity:0;width:360px;position:absolute;top:.5rem;right:0;height:1.6rem;">
                <input type="file" id="change" accept="image" @change="change" style="height:1.6rem;">
...
export default {
    ...
    methods: {
        ...
        postImg () {
            ...
            formData.append('avatar', this.picValue);
